...
Definition check_wf_extended_fresh (ac : AssuranceCase)
    (now : string) : bool :=
...
(* ================================================================== *)
(* check_wf_extended_fresh soundness                                  *)
(* ================================================================== *)
...
Lemma build_well_formed_fresh : forall ac now,
    check_wf_extended_fresh ac now = true ->
    (forall id n,
...
Proof.
  ...
  unfold check_wf_extended_fresh in Hcheck.
